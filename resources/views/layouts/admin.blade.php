        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{ Admin::route('contentManager.index') }}" class="site_title"><i class="fa fa-paw"></i>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="{{ Admin::route('contentManager.index') }}"><i class="fa fa-home"></i>
                                    Dashboard </a></li>
                            <li {{ Admin::requestIs('contentManager/post*') ? ' class=active' : '' }}><a><i
                                            class="fa fa-newspaper-o"></i> Content Manager <span
                            ...
                            <li><a href="{{ Admin::route('contentManager.menu.index') }}"><i class="fa fa-sitemap"></i>
                                    Menu Manager </a></li>
                            <li><a href="{{ Admin::route('contentManager.media') }}"><i class="fa fa-file-image-o"></i>
                                    Media Manager </a></li>
                            <li>
                                <a>
                                    <i class="fa fa-heartbeat" aria-hidden="true"></i>
                                    Clinic sites Manager
                                    <span class="fa fa-chevron-down"></span>
                                </a>
                                <ul class="nav child_menu">
                                    <li><a>Manager Clinic sites</a></li>
                                    <li>
                                        <a href="{{ Admin::route('siteBuilder.build') }}">Create Clinic site</a>
                                    </li>
                                </ul>
                            </li>
